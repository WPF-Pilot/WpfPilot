...
internal static class CommonHresultValues
{
	internal const long S_OK = 0x00000000; // Operation successful
	internal const long E_ABORT = 0x80004004; // Operation aborted
	internal const long E_ACCESSDENIED = 0x80070005; // General access denied error
	internal const long E_FAIL = 0x80004005; // Unspecified failure
	internal const long E_HANDLE = 0x80070006; // Handle that is not valid
	internal const long E_INVALIDARG = 0x80070057; // One or more arguments are not valid
	internal const long E_NOINTERFACE = 0x80004002; // No such interface supported
	internal const long E_NOTIMPL = 0x80004001; // Not implemented
	internal const long E_OUTOFMEMORY = 0x8007000E; // Failed to allocate necessary memory
	internal const long E_POINTER = 0x80004003; // Pointer that is not valid
	internal const long E_UNEXPECTED = 0x8000FFFF; // Unexpected failure
}
...
internal static class WindowsMessages
{
	...
	internal const uint WM_COMMNOTIFY = 0x0044;
	...
	internal const uint WM_KEYLAST = 0x0109;
	...
	internal const uint WM_MOUSELAST = 0x020D; // Win95: 0x0209, WinNT4,98: 0x020A
	...
	internal const uint WM_TABLET_FIRST = 0x02C0;
	internal const uint WM_TABLET_LAST = 0x02DF;
...
internal static class WindowLongParam
{
...
internal static class WindowStyles
{
	...
	//#if(WINVER >= 0x0500)
	internal const uint WS_EX_NOINHERITLAYOUT = 0x00100000; // Disable inheritance of mirroring by children
...
internal static class ShowWindowTypes
{
...
internal static class LayeredWindowAttributes
{
	internal const uint LWA_COLORKEY = 0x1;
...
[Flags]
internal enum VkKeyScanModifiers : byte
{
	NONE = 0,
	SHIFT = 0x01,
	CONTROL = 0x02,
...
/// </summary>
internal enum ScanCodeShort : ushort
{
	ESCAPE = 0x01,
	ESC = ESCAPE,
	KEY_1 = 0x02,
...
[Flags]
internal enum AccessibilityState : uint
{
...
internal enum AccessibilityRole : uint
{
...
/// </summary>
internal enum InjectedInputVisualizationMode
{
	/// <summary>
...
{
	internal static IntPtr TRUE = new(1);
	internal static IntPtr FALSE = new(0);
}
