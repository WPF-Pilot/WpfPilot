...
internal static class ProcessCloseOnParentClose
{
	...
	static ProcessCloseOnParentClose()
	{
		...
		string jobName = nameof(ProcessCloseOnParentClose) + Process.GetCurrentProcess().Id;
	...
	internal static extern bool SetInformationJobObject(IntPtr job, JobObjectInfoType infoType, IntPtr lpJobObjectInfo, uint cbJobObjectInfoLength);
